...
import { USUARIOS_SISTEMA, getRamal, getConsultorDisplayName } from '../constants'
              ...
              {agrupado[statusAberto]?.map(nome => (
                ...
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="font-bold text-gray-800 text-lg group-hover:text-orange-700">{getConsultorDisplayName(nome)}</span>
                    {/* 👇 ZOOM NO RAMAL AQUI TAMBÉM! */}
